...
### 1.2 澳洲毕业生找工作的两个方向
  - 找工作的两个方向
    - 校招：Graduate Program 
      - 一般都要求是 PR/citizen，但是对于IT学生，很多都不要
      - 国内也分春招和秋招
    ...
    - 社招：大部分学员的选择
      ...
      - Junior Level
        ...
        - 要求经验这么高，怎么入门？其实只是在公司的一个岗位（属于初级，入门的）而已
      - Mid Level
...
### 1.4 澳洲毕业生找offer的建议 
  - 找offer的建议
    ...
    - Team Match:
      ...
      - 华人在这部分，特别容易紧张，不会讲笑话；要有自信在，公司才会要你
...
- 首先看是否是中介/猎头
  ...
  - 公司招聘，直面的是HR；猎头会先过猎头一关
- 职位名称
- 公司介绍
- 工作内容
- 基本需求
- 专业需求
  - ideal，nice to have, 意思就是必须的
  - 10条的匹配能满足7条，是比较可能拿到面试的
- 特殊需求
- 申请要求
- 通过阅读jd，可以基本分类出来工作环境，条件，日常的部分信息
- 越大的公司jd写的往往越简单，越简单的描述，考核起来越头疼；写的越具体，反而越简单，公司想要能力匹配的人，过来工作的。
...
## 3.澳洲公司的招聘流程
  ...
  - Q: 背调 会确定对方的职位 在职时间 对吧, 如果有的老板不想给自己做背调怎么办😿
    - A: 这个挺常见，这个需要跟HR说，如果是猎头推的可以跟猎头说明，我们这个老板不愿意帮我去做背调，理由一定要很好（他比较忙，也不喜欢给你做背调），你可以提出同事，senior manager可不可以。背调主要是去check 面试的真伪性，过去经验的真实性，同时为这个人做背书。有的时候离职的原因，可能也是因为前老板剥削你，但是不要表达不清楚，让对方觉得是你瞎想的就好。
 ...
 - 对简历的一些反思
   ...
   - 你的核心竞争力是什么，你有没有核心竞争力
     ...
     - 跟你的专业性相关的技能，也可以作为你的核心竞争力，比如你是UI Designer + Full Stack developer，或者Full Stack developer + Devops engineer，加上很多的项目经验
 - 关于简历上陈述的Fact
...
### 5.3 Experience(重要) 
 - Experience（重要）：跟skills并列重要
   ...
   - Resume Experience的模版
    ...
    5. 前端测试框架:前端测试框架用的什么
    6. API应用:API应用使用什么规范，用的什么具体技术，怎样查看API，API文档如
    何管理的
    ...
    6.  AWS使用:使用哪些AWS具体服务，帮助App实现了部署，通过什么形式帮助部
    署
...
- Q: 如果公司没要求  是不是就不用写cover letter
  - A: 写一封email，要写清楚你有多么关心，多么渴望这个岗位；所以email求职，body要写的清楚
